...
do nfn=1,nfile
   ...
   print*,fnames(nfn)(1:lastchar(fnames(nfn))),nvbtab,huge(anal_table(1)%npointer)

   allocate (anal_table(nvbtab))
   do nv=1,nvbtab
      print*,huge(anal_table(nv)%npointer)
      !print *,'Reading line: ',nv
